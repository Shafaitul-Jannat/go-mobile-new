...
<html lang="en">
  ...
  <body>
            ...
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="http://www.webometrics.info/en/Asia/Bangladesh%20 " target="_blank">Ranking by Configuration</a>
                  <a class="dropdown-item" href="https://www.topuniversities.com/subject-rankings/2019" target="_blank">Ranking by User</a>
    ...
    <section class="site-hero site-sm-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/google-pixel-2-0313-014.jpg)">
      <div class="container">
              ...
              <form action="register.php" method="post">
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text"  name="email"class="form-control py-2" required>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="password"  name="password_1" class="form-control py-2 " required>
                    </div>
                  </div>
              <div class="row mb-5">
                    <div class="col-md-12 form-group">
                      <label >Re-type Password</label>
                      <input type="password"  name="password_2" class="form-control py-2" required>
                    </div>
                  </div> 
                  
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <input type="submit"  name="reg_user" value="Register" class="btn btn-primary px-5 py-2">
                      <p>Already a User? <a href="login.php" target="_blank"><b>Log In</b></a></p>
                    </div>
                  </div>
                </form>
              </div>
